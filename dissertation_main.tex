%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% Unofficial LaTeX template for dissertations at Technische Universität München (TUM)
%% Updates can be found at https://github.com/qiauil/tum-phd-dissertation
%%
%% Based on the University of Malta template by Prof. JP Ebejer 
...
\def\title{<Titel der Dissertation>}  % the title of your dissertation
\def\author{Vorname(n) Name}            % your full name
\def\department{<TUM School/Fakultät/ TUM Campus Straubing>}   % your department (e.g. Artificial Intelligence)
\def\awardinginstitution{<TUM School of/Fakultät für/ TUM Campus Straubing>} % the institution awarding the degree
\def\degree{Doktors/Doktorin der ………  (Dr. ….)} % the degree you are reading for (e.g. Doktor der Informatik (Dr.-Ing.))
\def\examchair{………………………………………………}
\def\firstexaminar{………………………………………………} % the name of the first examinar
\def\secondexaminar{………………………………………………} % the name of the second examinar
\def\thirdexaminar{………………………………………………} % the name of the third examinar, if applicable, otherwise comment out the line
\def\submissiondate{…………………} % the date of submission of the dissertation, should probably be fixed.
\def\acceptancedate{……………………} % the date of acceptance of the dissertation,
...
\begin{document}
%\input{frontmatter/title}  % the title page is custom and not part of the frontmatter, so it is included here before \frontmatter

\input{title_page/de.tex}
...
\appendix
	\input{appendix/published_version} 
